...
tupla=(nombre1,apellido,edad,nota1_1,nota2_1,nota3_1)
estudiante1.append(tupla)
...
tupla=(nombre2,apellido,edad,nota1_2,nota2_2,nota3_2)
estudiante2.append(tupla)
mediaponderada2=nota1_2*0.3+nota2_2*0.4+nota3_2*0.3
if mediaponderada1 >=7:
    llista1[nombre1]=mediaponderada1
else:
    if mediaponderada2 >=7:
        llista1[nombre2]=mediaponderada2
        
if nota1_1>=8 or nota2_1>=8 or nota3_1>=8:
    llista2[nombre1]=mediaponderada1
    
else:
    if nota1_2>=8 or nota2_2>=8 or nota3_2>=8:
        llista2[nombre2]=mediaponderada2
print(llista1)
print(llista2) 
